class ClaudeClineProxy < Formula
  ...
  url "https://github.com/Spinoza0/claude-cline-proxy/archive/refs/tags/v1.7.9.tar.gz"
  sha256 "c4ab95a2e27630a714e0b614aacd1eb152faca48c5e551ca740b5ceea2c0284f"
